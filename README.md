...
<p align="center"><a href="https://drive.google.com/file/d/13i3BIryXqRK6a371UInq4_03LQPuLLyK/view?usp=sharing" target="_blank">TuneRadar Demo</a></p>

## Description 🎼
TuneRadar is an implementation of Shazam's song recognition algorithm based on insights from these [resources](#resources--card_file_box). It integrates Spotify and YouTube APIs to find and download songs.
...
```
git clone https://github.com/ProfPython/TuneRadar.git
```
...
In a separate terminal window (oe a unix-like shell e.g MSYS2 if using the provided SQLite library):
```
cd TuneRadar
go run *.go serve [-proto <http|https> (default: http)] [-port <port number> (default: 3000)]
```
#### ▸ Download a Song 📥 
...
## Author :black_nib:
- Williams Anthony
  - Connect with me on [LinkedIn](https://www.linkedin.com/in/williams-anthony-90aa1623b).
  - Check out my other [GitHub](https://github.com/ProfPython) projects.
