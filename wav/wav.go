...
import (
	...
	"os/exec"
	"strings"
	"song-recognition/models"   // Assuming this is your custom package
    "song-recognition/utils" 

	"encoding/base64"  // Fixes "undefined: base64"
	"time"             // Fixes "undefined: time"
	"context"         // Fixes "undefined: context"
	"golang.org/x/xerrors" // Fixes "undefined: xerrors" (if needed)
	"log/slog"         // Fixes "undefined: slog"
)
